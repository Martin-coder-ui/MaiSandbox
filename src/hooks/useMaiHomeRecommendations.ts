...
interface MaiHomeRecommendations {
...
const defaultRecommendations: MaiHomeRecommendations = {
  banking: [
    {
...
export const useMaiHomeRecommendations = (
  userProfile: User['profileData'] | undefined,
  location?: GeolocationData | null,
  currentSeason?: string
) => {
  const [recommendations, setRecommendations] = useState<MaiHomeRecommendations>(defaultRecommendations);
  ...
  useEffect(() => {
    if (userProfile && userProfile.financeData) {
      ...
      setTimeout(() => {
        const newRecommendations: MaiHomeRecommendations = {
